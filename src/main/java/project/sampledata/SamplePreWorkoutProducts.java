...
public class SamplePreWorkoutProducts implements CommandLineRunner,SampleProduct {
    ...
    public void run(String... args) throws Exception {
        ...
        for (int index = 0; index<precount; index++){
            Product product=new Product(Long.valueOf(index+startingId),"ms index "+index+startingId,"desc", Math.toIntExact(index),"preworkout",100, preWorkoutNameList.get(index));
