...
public class SampleProteinProducts implements CommandLineRunner,SampleProduct{
    ...
    public void run(String... args) throws Exception {
        ...
        for (int index = 0; index<precount; index++){
            Product product=new Product(Long.valueOf(index+startingId),"ms index "+index+startingId,"desc", Math.toIntExact(index),"whey",1,  "Images/protein/"+proteinNameList.get(index));
